...
namespace Azure.ResourceManager.Consumption.Models
{
    public partial class ModernReservationTransaction
    {
        internal static ModernReservationTransaction DeserializeModernReservationTransaction(JsonElement element)
        {
            ...
            return new ModernReservationTransaction(id.Value, name.Value, type.Value, Optional.ToDictionary(tags), Optional.ToNullable(amount), armSkuName.Value, billingFrequency.Value, billingProfileId.Value, billingProfileName.Value, currency.Value, description.Value, Optional.ToNullable(eventDate), eventType.Value, invoice.Value, invoiceId.Value, invoiceSectionId.Value, invoiceSectionName.Value, Optional.ToNullable(purchasingSubscriptionGuid), purchasingSubscriptionName.Value, Optional.ToNullable(quantity), region.Value, reservationOrderId.Value, reservationOrderName.Value, term.Value);
        }
    }
}
