...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    {
        /// <summary> Initializes a new instance of Budget. </summary>
        public Budget()
        {
        ...
        /// <param name="filter"> May be used to filter budgets by resource group, resource, or meter. </param>
        ...
        internal Budget(string id, string name, string type, string eTag, CategoryType? category, decimal? amount, TimeGrainType? timeGrain, BudgetTimePeriod timePeriod, BudgetFilter filter, CurrentSpend currentSpend, IDictionary<string, Notification> notifications) : base(id, name, type, eTag)
        {
            Category = category;
            Amount = amount;
            TimeGrain = timeGrain;
