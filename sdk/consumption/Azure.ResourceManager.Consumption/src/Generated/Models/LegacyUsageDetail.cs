...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    {
        /// <summary> Initializes a new instance of LegacyUsageDetail. </summary>
        internal LegacyUsageDetail()
        {
        ...
        /// <param name="billingPeriodStartDate"> The billing period start date. </param>
        /// <param name="billingPeriodEndDate"> The billing period end date. </param>
        ...
        /// <param name="resourceId"> Azure resource manager resource identifier. </param>
        ...
        internal LegacyUsageDetail(string id, string name, string type, IReadOnlyDictionary<string, string> tags, UsageDetailsKind kind, string billingAccountId, string billingAccountName, DateTimeOffset? billingPeriodStartDate, DateTimeOffset? billingPeriodEndDate, string billingProfileId, string billingProfileName, string accountOwnerId, string accountName, string subscriptionId, string subscriptionName, DateTimeOffset? date, string product, string partNumber, Guid? meterId, MeterDetailsResponse meterDetails, decimal? quantity, decimal? effectivePrice, decimal? cost, decimal? unitPrice, string billingCurrency, string resourceLocation, string consumedService, string resourceId, string resourceName, string serviceInfo1, string serviceInfo2, string additionalInfo, string invoiceSection, string costCenter, string resourceGroup, string reservationId, string reservationName, string productOrderId, string productOrderName, string offerId, bool? isAzureCreditEligible, string term, string publisherName, string publisherType, string planName, string chargeType, string frequency) : base(id, name, type, tags, kind)
        {
        ...
        public MeterDetailsResponse MeterDetails { get; }
        ...
        /// <summary> Azure resource manager resource identifier. </summary>
