...
namespace Azure.ResourceManager.Consumption.Models
{
    public partial class LegacyReservationRecommendation
    {
        internal static LegacyReservationRecommendation DeserializeLegacyReservationRecommendation(JsonElement element)
        {
            ...
            return new LegacyReservationRecommendation(id.Value, name.Value, type.Value, Optional.ToDictionary(tags), kind, location.Value, sku.Value, lookBackPeriod.Value, Optional.ToNullable(instanceFlexibilityRatio), instanceFlexibilityGroup.Value, normalizedSize.Value, Optional.ToNullable(recommendedQuantityNormalized), Optional.ToNullable(meterId), term.Value, Optional.ToNullable(costWithNoReservedInstances), Optional.ToNullable(recommendedQuantity), Optional.ToNullable(totalCostWithReservedInstances), Optional.ToNullable(netSavings), Optional.ToNullable(firstUsageDate), scope.Value, Optional.ToList(skuProperties));
        }
    }
}
