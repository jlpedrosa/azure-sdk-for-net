...
{
    /// <summary> An marketplace resource. </summary>
    public partial class Marketplace : Resource
    {
        ...
        internal Marketplace(string id, string name, string type, IReadOnlyDictionary<string, string> tags, string billingPeriodId, DateTimeOffset? usageStart, DateTimeOffset? usageEnd, decimal? resourceRate, string offerName, string resourceGroup, string orderNumber, string instanceName, string instanceId, string currency, decimal? consumedQuantity, string unitOfMeasure, decimal? pretaxCost, bool? isEstimated, Guid? meterId, Guid? subscriptionGuid, string subscriptionName, string accountName, string departmentName, string consumedService, string costCenter, string additionalProperties, string publisherName, string planName, bool? isRecurringCharge) : base(id, name, type, tags)
        {
