...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    {
        internal static LegacyReservationTransaction DeserializeLegacyReservationTransaction(JsonElement element)
        {
            ...
            return new LegacyReservationTransaction(id.Value, name.Value, type.Value, Optional.ToDictionary(tags), Optional.ToNullable(eventDate), reservationOrderId.Value, description.Value, eventType.Value, Optional.ToNullable(quantity), Optional.ToNullable(amount), currency.Value, reservationOrderName.Value, purchasingEnrollment.Value, Optional.ToNullable(purchasingSubscriptionGuid), purchasingSubscriptionName.Value, armSkuName.Value, term.Value, region.Value, accountName.Value, accountOwnerEmail.Value, departmentName.Value, costCenter.Value, currentEnrollment.Value, billingFrequency.Value);
        }
    }
}
