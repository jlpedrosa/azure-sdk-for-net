...
namespace Azure.ResourceManager.Consumption.Models
{
    public partial class Notification : IUtf8JsonSerializable
    {
        ...
        internal static Notification DeserializeNotification(JsonElement element)
        {
            ...
            return new Notification(enabled, @operator, threshold, contactEmails, Optional.ToList(contactRoles), Optional.ToList(contactGroups), Optional.ToNullable(thresholdType));
        }
    }
}
