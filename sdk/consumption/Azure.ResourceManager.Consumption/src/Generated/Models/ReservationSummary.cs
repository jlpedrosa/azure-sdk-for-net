...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    public partial class ReservationSummary : Resource
    {
        ...
        /// <param name="usageDate"> Data corresponding to the utilization record. If the grain of data is monthly, it will be first day of month. </param>
        ...
        internal ReservationSummary(string id, string name, string type, IReadOnlyDictionary<string, string> tags, string reservationOrderId, string reservationId, string skuName, decimal? reservedHours, DateTimeOffset? usageDate, decimal? usedHours, decimal? minUtilizationPercentage, decimal? avgUtilizationPercentage, decimal? maxUtilizationPercentage, string kind, decimal? purchasedQuantity, decimal? remainingQuantity, decimal? totalReservedQuantity, decimal? usedQuantity, decimal? utilizedPercentage) : base(id, name, type, tags)
        {
