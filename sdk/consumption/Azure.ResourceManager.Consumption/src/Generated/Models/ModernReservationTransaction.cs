...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    public partial class ModernReservationTransaction : Resource
    {
        ...
        internal ModernReservationTransaction(string id, string name, string type, IReadOnlyDictionary<string, string> tags, decimal? amount, string armSkuName, string billingFrequency, string billingProfileId, string billingProfileName, string currency, string description, DateTimeOffset? eventDate, string eventType, string invoice, string invoiceId, string invoiceSectionId, string invoiceSectionName, Guid? purchasingSubscriptionGuid, string purchasingSubscriptionName, decimal? quantity, string region, string reservationOrderId, string reservationOrderName, string term) : base(id, name, type, tags)
        {
            Amount = amount;
