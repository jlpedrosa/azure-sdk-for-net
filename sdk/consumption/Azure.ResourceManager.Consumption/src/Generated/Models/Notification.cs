...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    public partial class Notification
    {
        ...
        /// <param name="contactEmails"> Email addresses to send the budget notification to when the threshold is exceeded. </param>
        ...
        /// <param name="contactGroups"> Action groups to send the budget notification to when the threshold is exceeded. </param>
        /// <param name="thresholdType"> The type of threshold. </param>
        internal Notification(bool enabled, OperatorType @operator, decimal threshold, IList<string> contactEmails, IList<string> contactRoles, IList<string> contactGroups, ThresholdType? thresholdType)
        {
            Enabled = enabled;
            Operator = @operator;
            Threshold = threshold;
        ...
        /// <summary> Email addresses to send the budget notification to when the threshold is exceeded. </summary>
        ...
        /// <summary> Action groups to send the budget notification to when the threshold is exceeded. </summary>
