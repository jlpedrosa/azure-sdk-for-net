...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    public partial class ModernReservationRecommendation : ReservationRecommendation
    {
        ...
        /// <param name="firstUsageDate"> The usage date for looking back. </param>
        /// <param name="scope"> Shared or single recommendation. </param>
        /// <param name="skuProperties"> List of sku properties. </param>
        internal ModernReservationRecommendation(string id, string name, string type, IReadOnlyDictionary<string, string> tags, ReservationRecommendationKind kind, string location, string sku, string lookBackPeriod, int? instanceFlexibilityRatio, string instanceFlexibilityGroup, string normalizedSize, float? recommendedQuantityNormalized, Guid? meterId, string term, Amount costWithNoReservedInstances, decimal? recommendedQuantity, Amount totalCostWithReservedInstances, Amount netSavings, DateTimeOffset? firstUsageDate, string scope, IReadOnlyList<SkuProperty> skuProperties) : base(id, name, type, tags, kind, location, sku)
        {
        ...
        public int? InstanceFlexibilityRatio { get; }
        ...
        public Amount CostWithNoReservedInstances { get; }
        ...
        public Amount TotalCostWithReservedInstances { get; }
        /// <summary> Total estimated savings with reserved instances. </summary>
        public Amount NetSavings { get; }
        /// <summary> The usage date for looking back. </summary>
        public DateTimeOffset? FirstUsageDate { get; }
