...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ModernUsageDetail. </summary>
        internal ModernUsageDetail()
        {
        ...
        /// <param name="billingPeriodStartDate"> Billing Period Start Date as in the invoice. </param>
        /// <param name="billingPeriodEndDate"> Billing Period End Date as in the invoice. </param>
        ...
        /// <param name="exchangeRateDate"> Date on which exchange rate used in conversion from pricing currency to billing currency. </param>
        ...
        /// <param name="productIdentifier"> Identifer for the product that has accrued charges by consumption or purchase . This is the concatenated key of productId and SKuId in partner center. </param>
        /// <param name="resourceLocationNormalized"> Resource Location Normalized. </param>
        /// <param name="servicePeriodStartDate"> Start date for the rating period when the service usage was rated for charges. The prices for Azure services are determined for the rating period. </param>
        /// <param name="servicePeriodEndDate"> End date for the period when the service usage was rated for charges. The prices for Azure services are determined based on the rating period. </param>
        ...
        /// <summary> Service Info 1. </summary>
        public string ServiceInfo1 { get; }
        /// <summary> Service Info 2. </summary>
        ...
        public DateTimeOffset? ExchangeRateDate { get; }
        ...
        /// <summary> Identifer for the product that has accrued charges by consumption or purchase . This is the concatenated key of productId and SKuId in partner center. </summary>
