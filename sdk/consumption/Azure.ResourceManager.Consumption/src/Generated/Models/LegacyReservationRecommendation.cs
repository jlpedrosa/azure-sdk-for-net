...
namespace Azure.ResourceManager.Consumption.Models
{
    ...
    {
        /// <summary> Initializes a new instance of LegacyReservationRecommendation. </summary>
        internal LegacyReservationRecommendation()
        {
        ...
        internal LegacyReservationRecommendation(string id, string name, string type, IReadOnlyDictionary<string, string> tags, ReservationRecommendationKind kind, string location, string sku, string lookBackPeriod, int? instanceFlexibilityRatio, string instanceFlexibilityGroup, string normalizedSize, float? recommendedQuantityNormalized, Guid? meterId, string term, decimal? costWithNoReservedInstances, decimal? recommendedQuantity, decimal? totalCostWithReservedInstances, decimal? netSavings, DateTimeOffset? firstUsageDate, string scope, IReadOnlyList<SkuProperty> skuProperties) : base(id, name, type, tags, kind, location, sku)
        {
