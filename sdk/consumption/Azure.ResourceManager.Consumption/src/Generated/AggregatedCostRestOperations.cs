...
namespace Azure.ResourceManager.Consumption
{
    internal partial class AggregatedCostRestOperations
    {
        ...
        public AggregatedCostRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint = null, string apiVersion = "2019-10-01")
        {
        ...
        internal HttpMessage CreateGetForBillingPeriodByManagementGroupRequest(string managementGroupId, string billingPeriodName)
        {
            ...
            uri.AppendPath("/Microsoft.Consumption/aggregatedcost", false);
            uri.AppendQuery("api-version", apiVersion, true);
            request.Uri = uri;
            request.Headers.Add("Accept", "application/json");
            return message;
